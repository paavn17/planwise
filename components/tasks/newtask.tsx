        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            ...
            <select
              ...
              onChange={handleChange}
              className={`w-full p-3 rounded bg-gradient-to-r ${getPriorityColor(formData.priority)} text-white border border-gray-300 text-sm`}
            >
          ...
          <div>
            ...
            <select
              ...
              onChange={handleChange}
              className={`w-full p-3 rounded bg-gradient-to-r ${getStatusColor(formData.status)} text-white border border-gray-300 text-sm`}
            >
